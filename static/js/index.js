window.onload = function() {
	...
	image.style.cssText = public_height;
	var img = document.getElementById('img');
	img.style.cssText = 'width:' + broser_width/2 + 'px;';
	img.style.cssText = public_height;
	var box = document.getElementById('box');
	box.style.cssText = public_height;
	box.style.cssText = 'width:' + (broser_width-50) / 2 + 'px;';
	var earth = document.getElementById('earth');
	earth.style.cssText = 'height:' + broser_width * 0.6 / 2 + 'px;';
//画地球仪
